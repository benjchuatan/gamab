				...
				<table class="table">
					  ...
					  <tbody>
					    <tr>
					      ...
					      <td>${p.description}</td>
					      <td>${p.price}</td>
					      <td><p data-placement="top" data-toggle="tooltip" title="Edit"><button class="btn btn-info btn-s" data-title="Edit" data-toggle="modal" data-target="#edit" ><a href="EditProductServlet?id=${p.idproducts}"><span class="glyphicon glyphicon-pencil"></a></span></button></p></td>
